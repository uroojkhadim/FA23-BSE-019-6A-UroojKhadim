                    ...
                    menu.filter(item => item.category === cat).map((item, idx) => (
                      ...
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          addToCart(item);
                          toast.success(`${item.name} added to curation`);
                        }}
                        className="w-16 h-16 bg-white/5 border border-glass-border rounded-[20px] flex items-center justify-center group-hover:bg-primary group-hover:text-white group-hover:border-primary group-hover:shadow-2xl group-hover:shadow-primary/40 transition-all duration-500 active:scale-90"
                      >
                        <Plus size={28} />
                      </button>
                    </motion.div>
