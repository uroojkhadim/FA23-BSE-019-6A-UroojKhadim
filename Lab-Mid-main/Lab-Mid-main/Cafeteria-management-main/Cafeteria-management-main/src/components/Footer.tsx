        ...
        <div className="grid grid-cols-12 gap-6 sm:gap-8">
          ...
          <div className="col-span-12 md:col-span-4">
            ...
            <div className="flex gap-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-sky-600 rounded-xl flex items-center justify-center transition-all hover:scale-110" aria-label="Facebook">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-sky-400 rounded-xl flex items-center justify-center transition-all hover:scale-110" aria-label="Twitter">
            ...
            <nav className="flex flex-col gap-3">
              {quickLinks.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  className="font-paragraph text-sm text-slate-300 hover:text-sky-400 hover:translate-x-1 transition-all inline-block w-fit"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div className="col-span-12 md:col-span-4">
            ...
            <div className="space-y-4">
              <a href="https://maps.google.com/?q=COMSATS+Islamabad+Campus" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 group">
                <MapPin className="w-5 h-5 text-sky-400 flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform" strokeWidth={1.5} />
                <div>
                  <p className="font-paragraph text-xs uppercase tracking-wide text-sky-400 mb-1">Address</p>
              ...
              <a href="mailto:cafeteria@comsats.edu.pk" className="flex items-start gap-3 group">
                <Mail className="w-5 h-5 text-sky-400 flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform" strokeWidth={1.5} />
                <div>
                  <p className="font-paragraph text-xs uppercase tracking-wide text-sky-400 mb-1">Email</p>
              ...
              <a href="tel:+925112345678" className="flex items-start gap-3 group">
                <Phone className="w-5 h-5 text-sky-400 flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform" strokeWidth={1.5} />
                <div>
                  <p className="font-paragraph text-xs uppercase tracking-wide text-sky-400 mb-1">Phone</p>
              ...
              <a href="https://wa.me/923000000000" target="_blank" rel="noopener noreferrer" className="block pt-4 border-t border-white/10 group">
                <p className="font-paragraph text-xs text-slate-400">
                  WhatsApp: <span className="text-white font-semibold group-hover:text-sky-400 transition-colors">+92 300 0000000</span>
                </p>
              </a>
            </div>
          </div>
        ...
        <div className="mt-10 sm:mt-16 pt-8 border-t border-white/10">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <Link to="#" className="font-paragraph text-xs text-slate-400 hover:text-sky-400 transition-colors">
                Privacy Policy
              </Link>
              <Link to="#" className="font-paragraph text-xs text-slate-400 hover:text-sky-400 transition-colors">
                Terms of Service
